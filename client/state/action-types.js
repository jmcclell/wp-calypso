...
export const FIRST_VIEW_DISABLE = 'FIRST_VIEW_DISABLE';
export const FIRST_VIEW_DISABLED_SET = 'FIRST_VIEW_DISABLED_SET';
export const FIRST_VIEW_ENABLE = 'FIRST_VIEW_ENABLE';
export const FIRST_VIEW_HIDE = 'FIRST_VIEW_HIDE';
export const FIRST_VIEW_SHOW = 'FIRST_VIEW_SHOW';
export const FIRST_VIEW_VISIBLE_SET = 'FIRST_VIEW_VISIBLE_SET';
...
export const PURCHASE_REMOVE = 'PURCHASE_REMOVE';
